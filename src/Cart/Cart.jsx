                                        ...
                                        <tbody>
                                            {
                                                list_carts && list_carts.map((value, index) => (
                                                    <tr key={index}>
                                                        ...
                                                        <td className="li-product-thumbnail"><Link to={`/detail/${value.id_product}`}><img src={`http://localhost:8000${value.image}`} style={{ width: '5rem' }} alt="Li's Product Image" /></Link></td>
