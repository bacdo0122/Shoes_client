                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6">
                                <div className="footer-logo">
                                    ...
                                    <p className="info">
                                        Chúng tôi mang đến những trải nghiệm độc đáo và các sản phẩm mới lạ
                                </p>
                                </div>
                                <ul className="des">
                                    <li>
                                    ...
                                    <li>
                                        <span>Email: </span>
                                        <a href="mailto://tienkim9920@gmail.com"></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="col-lg-2 col-md-3 col-sm-6">
                                <div className="footer-block">
                                    <h3 className="footer-block-title">Công ty của chúng tôi</h3>
                                        <ul>
                                            <li><a href="#">Giao hàng</a></li>
                                            <li><a href="#">Thông báo hợp lệ</a></li>
